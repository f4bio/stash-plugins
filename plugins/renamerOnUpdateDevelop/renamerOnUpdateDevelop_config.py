...
# 			Attention: Only recommended if the scene linked tags number is not that big due to maximum filename length
tags_whitelist = [
    # "Brunette", "Blowjob"
]
...
# Field to remove if the path is too long. First in list will be removed then second ... if length is still too long.
order_field = [
    "$video_codec",
    "$audio_codec",
    "$resolution",
